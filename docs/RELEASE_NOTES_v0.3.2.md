...
- Windows 用户优先下载 `GoAgent-0.3.2-win-x64-portable.zip` 免安装版。
- macOS Apple Silicon 下载 `GoAgent-0.3.2-mac-arm64.dmg`。
- macOS Intel 下载 `GoAgent-0.3.2-mac-x64.dmg`。
