...
GoAgent v0.4.7 adds the adaptive analysis runtime: KataGo analysis now carries cache status, adaptive profile metadata, move classification 2.0, PV confidence, evidence bundles and teaching-readiness signals into the teacher flow. The goal is simple: faster repeated review, clearer confidence boundaries, and fewer overconfident explanations when evidence is still weak.

QQ 群：1030632742，欢迎一起交流、提建议、完善 GoAgent。

> v0.4.7 provides the Windows NVIDIA edition as both [GoAgent-0.4.7-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia.exe) and [GoAgent-0.4.7-win-x64-nvidia-portable.7z](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia-portable.7z). The portable package is slimmed to stay below GitHub's 2 GB single-asset upload limit.
...
| 平台 / 场景 | 推荐下载 |
| --- | --- |
| macOS Apple Silicon（M1/M2/M3/M4） | [GoAgent-0.4.7-mac-arm64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-arm64.dmg) |
| macOS Intel | [GoAgent-0.4.7-mac-x64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-x64.dmg) |
| Windows x64 安装版，普通用户推荐 | [GoAgent-0.4.7-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64.exe) |
| Windows x64 免安装版 | [GoAgent-0.4.7-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-portable.zip) |
| Windows x64 NVIDIA 专版安装版 | [GoAgent-0.4.7-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia.exe) |
| Windows x64 NVIDIA 专版免安装 7z | [GoAgent-0.4.7-win-x64-nvidia-portable.7z](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia-portable.7z) |
| 校验文件 | [SHA256SUMS.txt](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/SHA256SUMS.txt) |
...
| macOS Apple Silicon（M1/M2/M3/M4） | [GoAgent-0.4.7-mac-arm64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-arm64.dmg) |
| macOS Intel | [GoAgent-0.4.7-mac-x64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-x64.dmg) |
| Windows x64 安裝版，一般用戶推薦 | [GoAgent-0.4.7-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64.exe) |
| Windows x64 免安裝版 | [GoAgent-0.4.7-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-portable.zip) |
| Windows x64 NVIDIA 專版安裝版 | [GoAgent-0.4.7-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia.exe) |
| Windows x64 NVIDIA 專版免安裝包 | [GoAgent-0.4.7-win-x64-nvidia-portable.7z](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia-portable.7z) |
| 校驗檔 | [SHA256SUMS.txt](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/SHA256SUMS.txt) |
...
| --- | --- |
| macOS Apple Silicon | [GoAgent-0.4.7-mac-arm64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-arm64.dmg) |
| macOS Intel | [GoAgent-0.4.7-mac-x64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-x64.dmg) |
| Windows x64 installer, recommended for most users | [GoAgent-0.4.7-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64.exe) |
| Windows x64 portable ZIP | [GoAgent-0.4.7-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-portable.zip) |
| Windows x64 NVIDIA installer | [GoAgent-0.4.7-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia.exe) |
| Windows x64 NVIDIA portable 7z | [GoAgent-0.4.7-win-x64-nvidia-portable.7z](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia-portable.7z) |
| Checksums | [SHA256SUMS.txt](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/SHA256SUMS.txt) |
...
| macOS Apple Silicon | [GoAgent-0.4.7-mac-arm64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-arm64.dmg) |
| macOS Intel | [GoAgent-0.4.7-mac-x64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-x64.dmg) |
| Windows x64 インストーラー | [GoAgent-0.4.7-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64.exe) |
| Windows x64 ポータブル ZIP | [GoAgent-0.4.7-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-portable.zip) |
| Windows x64 NVIDIA インストーラー | [GoAgent-0.4.7-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia.exe) |
| Windows x64 NVIDIA ポータブル 7z | [GoAgent-0.4.7-win-x64-nvidia-portable.7z](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia-portable.7z) |
| チェックサム | [SHA256SUMS.txt](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/SHA256SUMS.txt) |
...
| macOS Apple Silicon | [GoAgent-0.4.7-mac-arm64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-arm64.dmg) |
| macOS Intel | [GoAgent-0.4.7-mac-x64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-x64.dmg) |
| Windows x64 설치 프로그램 | [GoAgent-0.4.7-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64.exe) |
| Windows x64 포터블 ZIP | [GoAgent-0.4.7-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-portable.zip) |
| Windows x64 NVIDIA 설치 프로그램 | [GoAgent-0.4.7-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia.exe) |
| Windows x64 NVIDIA 포터블 7z | [GoAgent-0.4.7-win-x64-nvidia-portable.7z](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia-portable.7z) |
| 체크섬 | [SHA256SUMS.txt](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/SHA256SUMS.txt) |
...
| macOS Apple Silicon | [GoAgent-0.4.7-mac-arm64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-arm64.dmg) |
| macOS Intel | [GoAgent-0.4.7-mac-x64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-mac-x64.dmg) |
| Windows x64 installer | [GoAgent-0.4.7-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64.exe) |
| Windows x64 portable ZIP | [GoAgent-0.4.7-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-portable.zip) |
| Windows x64 NVIDIA installer | [GoAgent-0.4.7-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia.exe) |
| Windows x64 NVIDIA portable 7z | [GoAgent-0.4.7-win-x64-nvidia-portable.7z](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia-portable.7z) |
| Checksums | [SHA256SUMS.txt](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/SHA256SUMS.txt) |
