...
| 平台 / 场景 | 推荐下载 |
| --- | --- |
| macOS Apple Silicon | `GoMentor-0.3.10-mac-arm64.dmg` |
| macOS Intel | `GoMentor-0.3.10-mac-x64.dmg` |
| Windows 普通版，OpenCL 推荐包 | `GoMentor-0.3.10-win-x64.exe` 或 `GoMentor-0.3.10-win-x64-portable.zip` |
| Windows NVIDIA 专版，适合 NVIDIA 显卡和 CUDA 环境 | `GoMentor-0.3.10-win-x64-nvidia.exe` 或 `GoMentor-0.3.10-win-x64-nvidia-portable.zip` |
| 校验文件 | `SHA256SUMS.txt` |
...
- 注意：显卡厂商的 OpenCL 驱动仍来自用户电脑的 NVIDIA / AMD / Intel 驱动，GoMentor 不替代显卡驱动。
...
| macOS Apple Silicon | `GoMentor-0.3.10-mac-arm64.dmg` |
| macOS Intel | `GoMentor-0.3.10-mac-x64.dmg` |
| Windows 一般版，OpenCL 推薦包 | `GoMentor-0.3.10-win-x64.exe` 或 `GoMentor-0.3.10-win-x64-portable.zip` |
| Windows NVIDIA 專版 | `GoMentor-0.3.10-win-x64-nvidia.exe` 或 `GoMentor-0.3.10-win-x64-nvidia-portable.zip` |
| 校驗檔 | `SHA256SUMS.txt` |
...
| macOS Apple Silicon | `GoMentor-0.3.10-mac-arm64.dmg` |
| macOS Intel | `GoMentor-0.3.10-mac-x64.dmg` |
| Standard Windows x64, OpenCL recommended | `GoMentor-0.3.10-win-x64.exe` or `GoMentor-0.3.10-win-x64-portable.zip` |
| Windows NVIDIA edition for NVIDIA GPUs and CUDA runtimes | `GoMentor-0.3.10-win-x64-nvidia.exe` or `GoMentor-0.3.10-win-x64-nvidia-portable.zip` |
...
| macOS Apple Silicon | `GoMentor-0.3.10-mac-arm64.dmg` |
| macOS Intel | `GoMentor-0.3.10-mac-x64.dmg` |
| Windows 標準版、OpenCL 推奨 | `GoMentor-0.3.10-win-x64.exe` または `GoMentor-0.3.10-win-x64-portable.zip` |
| NVIDIA GPU / CUDA 向け Windows NVIDIA 版 | `GoMentor-0.3.10-win-x64-nvidia.exe` または `GoMentor-0.3.10-win-x64-nvidia-portable.zip` |
...
| macOS Apple Silicon | `GoMentor-0.3.10-mac-arm64.dmg` |
| macOS Intel | `GoMentor-0.3.10-mac-x64.dmg` |
| Windows 표준 x64, OpenCL 권장 | `GoMentor-0.3.10-win-x64.exe` 또는 `GoMentor-0.3.10-win-x64-portable.zip` |
| NVIDIA GPU / CUDA용 Windows NVIDIA 에디션 | `GoMentor-0.3.10-win-x64-nvidia.exe` 또는 `GoMentor-0.3.10-win-x64-nvidia-portable.zip` |
| 체크섬 | `SHA256SUMS.txt` |
...
| macOS Apple Silicon | `GoMentor-0.3.10-mac-arm64.dmg` |
| macOS Intel | `GoMentor-0.3.10-mac-x64.dmg` |
| Windows x64 รุ่นมาตรฐาน แนะนำ OpenCL | `GoMentor-0.3.10-win-x64.exe` หรือ `GoMentor-0.3.10-win-x64-portable.zip` |
| Windows NVIDIA edition สำหรับ NVIDIA GPU และ CUDA | `GoMentor-0.3.10-win-x64-nvidia.exe` หรือ `GoMentor-0.3.10-win-x64-nvidia-portable.zip` |
| Checksums | `SHA256SUMS.txt` |
...
| macOS Apple Silicon | `GoMentor-0.3.10-mac-arm64.dmg` |
| macOS Intel | `GoMentor-0.3.10-mac-x64.dmg` |
| Windows x64 tiêu chuẩn, khuyến nghị OpenCL | `GoMentor-0.3.10-win-x64.exe` hoặc `GoMentor-0.3.10-win-x64-portable.zip` |
| Windows NVIDIA edition cho GPU NVIDIA và CUDA | `GoMentor-0.3.10-win-x64-nvidia.exe` hoặc `GoMentor-0.3.10-win-x64-nvidia-portable.zip` |
| Checksums | `SHA256SUMS.txt` |
