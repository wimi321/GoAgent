...
[GoMentor v0.3.14](https://github.com/wimi321/GoMentor/releases/tag/v0.3.14)

| 平台 | 下载 |
| --- | --- |
| macOS Apple Silicon | [GoMentor-0.3.14-mac-arm64.dmg](https://github.com/wimi321/GoMentor/releases/download/v0.3.14/GoMentor-0.3.14-mac-arm64.dmg) |
| macOS Intel | [GoMentor-0.3.14-mac-x64.dmg](https://github.com/wimi321/GoMentor/releases/download/v0.3.14/GoMentor-0.3.14-mac-x64.dmg) |
| Windows x64 免安装 ZIP | [GoMentor-0.3.14-win-x64-portable.zip](https://github.com/wimi321/GoMentor/releases/download/v0.3.14/GoMentor-0.3.14-win-x64-portable.zip) |
| Windows x64 安装版 | [GoMentor-0.3.14-win-x64.exe](https://github.com/wimi321/GoMentor/releases/download/v0.3.14/GoMentor-0.3.14-win-x64.exe) |
| Windows NVIDIA 免安装 ZIP | [GoMentor-0.3.14-win-x64-nvidia-portable.zip](https://github.com/wimi321/GoMentor/releases/download/v0.3.14/GoMentor-0.3.14-win-x64-nvidia-portable.zip) |
| Windows NVIDIA 安装版 | [GoMentor-0.3.14-win-x64-nvidia.exe](https://github.com/wimi321/GoMentor/releases/download/v0.3.14/GoMentor-0.3.14-win-x64-nvidia.exe) |
