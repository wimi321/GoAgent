...
[GoAgent v0.4.7](https://github.com/wimi321/GoAgent/releases/tag/v0.4.7)
...
| Windows x64 免安装 ZIP | [GoAgent-0.4.7-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-portable.zip) |
| Windows x64 安装版 | [GoAgent-0.4.7-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64.exe) |
| Windows NVIDIA 安装版 | [GoAgent-0.4.7-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia.exe) |
| Windows NVIDIA 免安装 7z | [GoAgent-0.4.7-win-x64-nvidia-portable.7z](https://github.com/wimi321/GoAgent/releases/download/v0.4.7/GoAgent-0.4.7-win-x64-nvidia-portable.7z) |
