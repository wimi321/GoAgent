...
| 平台 | 下载 |
| --- | --- |
| macOS Apple Silicon | [GoAgent-0.3.18-mac-arm64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.3.18/GoAgent-0.3.18-mac-arm64.dmg) |
| macOS Intel | [GoAgent-0.3.18-mac-x64.dmg](https://github.com/wimi321/GoAgent/releases/download/v0.3.18/GoAgent-0.3.18-mac-x64.dmg) |
| Windows x64 免安装 ZIP | [GoAgent-0.3.18-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.3.18/GoAgent-0.3.18-win-x64-portable.zip) |
| Windows x64 安装版 | [GoAgent-0.3.18-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.3.18/GoAgent-0.3.18-win-x64.exe) |
| Windows NVIDIA 免安装 ZIP | [GoAgent-0.3.18-win-x64-nvidia-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.3.18/GoAgent-0.3.18-win-x64-nvidia-portable.zip) |
| Windows NVIDIA 安装版 | [GoAgent-0.3.18-win-x64-nvidia.exe](https://github.com/wimi321/GoAgent/releases/download/v0.3.18/GoAgent-0.3.18-win-x64-nvidia.exe) |
