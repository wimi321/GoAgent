...
| Windows x64 portable ZIP | [GoAgent-0.3.18-win-x64-portable.zip](https://github.com/wimi321/GoAgent/releases/download/v0.3.18/GoAgent-0.3.18-win-x64-portable.zip) |
| Windows x64 installer | [GoAgent-0.3.18-win-x64.exe](https://github.com/wimi321/GoAgent/releases/download/v0.3.18/GoAgent-0.3.18-win-x64.exe) |
